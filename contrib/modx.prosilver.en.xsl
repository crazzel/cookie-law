	...
	return toggle_display(o, s);
		...
		<div id="wrap">
			<div id="page-header">
				...
				<fieldset class="nobg">
					<label for="language"><span id="lang-slg">Select language:</span></label>&nbsp;<select id="language" name="language" onclick="load_languages()"><option value="pl" selected="selected">Polski</option></select>
				</fieldset>
				</form>
			</div>
			<div id="page-body">
